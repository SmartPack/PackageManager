...
<ol>
    ...
    <li><b>Uninstall</b> – Uninstall applications, including system apps with root or or Shizuku permissions. On non-rooted devices, only user apps can be removed. Guidance is provided to remove system apps on non-rooted devices via ADB</li>
